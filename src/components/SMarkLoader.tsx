  ...
  return (
    <div className={`relative ${className}`}>
      <svg viewBox="0 0 100.44 124.03" xmlns="http://www.w3.org/2000/svg" className="w-full h-full overflow-visible">
        ...
        />
        <path d={sPath} fill="#fff" style={{ opacity: fill, transition: "opacity 300ms ease" }} />
      </svg>
      {/* Barra de cores colorida */}
      <div className="mt-8 h-1.5 w-full rounded-full overflow-hidden flex">
        {[
          { c: "#c084fc", w: 12.5 },
          { c: "#f87171", w: 12.5 },
          { c: "#fb923c", w: 12.5 },
