  ...
  return (
    ...
    >
      <div className="relative flex items-center justify-end">
        ...
        <div className="relative flex items-center gap-3 glass rounded-full p-1.5 overflow-hidden transition-all duration-500 ease-out max-w-[48px] group-hover:max-w-[280px] group-hover:pr-4 group-hover:bg-noir-50">
          ...
          <div className="flex flex-col whitespace-nowrap opacity-0 translate-x-4 transition-all duration-500 group-hover:opacity-100 group-hover:translate-x-0">
            <span className="text-[10px] font-mono font-bold uppercase tracking-[0.2em] text-noir-300 group-hover:text-noir-600">
              Falar agora
            </span>
            <span className="text-[14px] font-medium text-noir-50 group-hover:text-noir-950">
